function make_figures_local_2d_Gauss(LeapSize,epsilon,beta)
addpath(genpath('..'))
% HOME=getenv('HOME');
HOME='/media/Gondor';
whos
...
savepath = strcat(HOME,'/Data/HMC_reducedflip/2D-Gauss',savestr);
figpath1 = strcat(HOME,'/Data/HMC_reducedflip/2D-Gauss/figures/',savestr,'autocor');
figpath2 = strcat(HOME,'/Data/HMC_reducedflip/2D-Gauss/figures/',savestr,'autocor-fevals');
