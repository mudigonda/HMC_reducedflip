...
%     Nsamp = 1e4;
    ...
    theta = [1,0;0,1e-2];
%     theta = [1,0;0,1e-3];
%     theta = random_covariance(opts.DataSize,opts.skew_dims)
...
plot_autocorr_samples(Xstandard,Xstandard_persist,Xreduced_flip,X_2_momentum);
plot_fevals(fevalsstandard,fevalsstandard_persist,fevalsreduced_flip,feval_2_momentum);
